...
func NewValidatorClient(apiKey string) *ValidatorClient {
...
func (c *ValidatorClient) GetValidatorInfo(network string, account string) (info ValidatorInfo, err error) {
